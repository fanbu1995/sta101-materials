...
download.file("https://raw.githubusercontent.com/fanbuduke17/sta101-materials/main/Labs/lab9/lab9.Rmd", destfile = "lab9.Rmd", method = "curl", extra = "-k")
```
...
1.  Is this an observational study or an experiment? The original research
    ...
    answer this question as it is phrased? If not, rephrase the question. (*Hint*: "leads to" implies a causal relationship.)
...
2.  Replot the scatterplot, but this time use `geom = "jitter`. What was
...
3.  Let's see if the apparent trend in the plot is something more than
...
<!-- 4.  Use residual plots to evaluate whether the conditions of least squares -->
<!--     regression are reasonable. Provide plots and comments for each one (see -->
<!--     Lab 8 on simple linear regression for a reminder of how to make these). -->
...
5.  P-values and parameter estimates should only be trusted if the
...
7.  What is the equation of the line corresponding to males? (*Hint:* For
    males, the parameter estimate for $\beta_2$ should be multiplied by 1 instead of 0.) For two professors
...
Let's run this full model first...
...
9. Fit the model and provide the model output. Which variable has the highest p-value in this model? Accoding to the p-values, which variable is most likely to have a significant association with the professor score?
<!--     Why? *Hint:* Think about which variable would you expect to **not** have any  -->
<!--     association with the professor score. -->


<!-- 10. Check your suspicions from the previous exercise. Include the model output -->
<!--     in your response. -->

11. Interpret the coefficient associated with the `ethnicity` variable.

12. Drop the variable with the highest p-value and re-fit the model. Did the
...
13. Using backward-selection and p-value as the selection criterion (with significant level $\alpha = 0.05$),
    determine the best model. You do not need to show all steps in your
    answer, just list the viariables you have **removed** from the model and provide the output for the **final** model. Also, write out the linear
    model for predicting score based on the final model you settle on.

<!-- 14. Verify that the conditions for this model are reasonable using diagnostic  -->
<!--     plots. -->
