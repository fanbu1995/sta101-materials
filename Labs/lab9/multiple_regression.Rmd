...
7.  What is the equation of the line corresponding to males? (*Hint:* For
    males, the parameter estimate for $\beta_2$ should be multiplied by 1.) For two professors
...
9. Which variable would you expect to have the highest p-value in this model? 
