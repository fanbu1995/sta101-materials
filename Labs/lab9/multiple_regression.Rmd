...
9. Which variable has the highest p-value in this model? Accoding to the p-values, which variable is more likely to have a significant association with the professor score?
...
13. Using backward-selection and p-value as the selection criterion,
