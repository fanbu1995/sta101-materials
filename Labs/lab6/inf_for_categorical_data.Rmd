...
function already loaded in your console's enviromment from last time, but note that inorder to create a fully reproducible lab report you need to load it in your markdown document as well.
