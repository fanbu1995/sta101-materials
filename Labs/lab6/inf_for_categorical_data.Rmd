...
1.  Describe the sampling distribution of sample proportions at $n = 300$ and 
    $p = 0.1$. Be sure to note the center and the shape.
...
1.  If you refer to Table 6 in the report, you'll find that Ecuador has a sample 
    ...
    report does? (**Hint**: check if the distribution looks nearly normal, and also think
    about the sucess-failure conditions.)
