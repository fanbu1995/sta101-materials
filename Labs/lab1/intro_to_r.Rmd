...
```{r load-template}
download.file("https://raw.githubusercontent.com/fanbuduke17/sta101-materials/main/Labs/lab1/lab1.Rmd", destfile = "lab1.Rmd", method = "curl", extra = "-k")
```
...
Before you keep going type your name and then click on *Knit HTML* and you'll see your document in a 
new pop-up window.
...
These packages may have already been installed in the RStudio container, however if 
they are not, you can install them via the following commands
```{r}
install.packages(c('dplyr', 'ggplot2'))
```

After installing the packages, you will still
...
3.   Make a plot that displays the proportion of boys born over time. What do you see? Does Arbuthnot's observation about boys being born in greater proportion than girls 
...
4.   In what year did we see the most total number of births in the U.S.? *Hint:*
...
Hit the drop down menu on the right of the **Knit** button, then select **Knit to PDF** to produce a PDF file as your lab report. 

Then you can download the PDF file using the **Export** function from the RStudio container (as shown in the image below).

![rinterface](submit.png)
