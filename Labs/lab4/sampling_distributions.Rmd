...
download.file("https://raw.githubusercontent.com/fanbuduke17/sta101-materials/main/Labs/lab4/lab4.Rmd", 
              destfile = "lab4.Rmd", method = "curl", extra = "-k")
```
...
is new to you, review the previous lab and ask me.
</div>
...
1.  Would you expect the mean of your sample to match the mean of another student's 
    sample? Why, or why not? If the answer is no, would you expect the means to
    just be somewhat different or very different? Ask a neighboring student to confirm 
    your answer.
...
1.  Create sampling distributions of means of `area`s from
...
8.   Take a sample of size 15 from the population and calculate the mean `price`
    of the homes in this sample. Using this sample, what is your best point estimate
    of the population mean of prices of homes?

9.  Since you have access to the population, simulate the sampling 
...
10.   Change your sample size from 15 to 150, then compute the sampling 
...
11.   Of the sampling distributions from Exercise 9 and Exercise 10, which has a smaller spread?  If
