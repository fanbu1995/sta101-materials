...
```{r copy template}
download.file("https://github.com/fanbuduke17/sta101-materials/blob/045daed38a5cb05e929120b61979ba6f36580be8/Labs/lab2/lab2.Rmd", destfile = "lab2.Rmd", method = "curl", extra = "-k")
```
