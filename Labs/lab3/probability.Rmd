...
download.file("https://raw.githubusercontent.com/fanbuduke17/sta101-materials/main/Labs/lab3/lab3.Rmd", 
              destfile = "lab3.Rmd", method = "curl", extra = "-k")
```
...
events. This paper started a great controversy that continues to this day, as you can see by Googling *hot hand basketball*.
...
9.   What concepts from the textbook are covered in this lab? What concepts, if 
