...
download.file("https://raw.githubusercontent.com/fanbuduke17/sta101-materials/main/Labs/lab8/lab8.Rmd", destfile = "lab8.Rmd", method = "curl", extra = "-k")
```
...
11.   Check the model diagnostics for the regression model with the variable you 
    think is the better predictor (between `at_bats` and the one you chose in Ex.9) for runs.
